...
const KalyanKarnatakaRegion = () => {
  const districts = [
    ...
    { id: "bidar", name: "Bidar", image: "/Images/KKR Region/Bidar/bidar_fort.jpg" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50" >
      {/* Hero Banner */}
      <section className="relative w-20 md:h-20 lg:h-[28rem] xl:h-[32rem]" >
        {/* <img 
          src="/Images/KKR Region/Klb/kalaburgi.jpg"  
          alt="Kalyan Karnataka Banner" 
